...
module.questConfigs = {
    {
            ...
            frames = {
                {
                    dialogs = {
                        ...
                        {char = "kat", text = "Wow Liz, you have good eyes!"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "Oh snap! That’s a good one!"},
                        {
                            char = "kat",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        {char = "kat", text = "Liz, never... ever... ever..."},
                        {
                            char = "kat",
                            text = "...ask for a creature's backstory"
                        },
                        {char = "kat", text = "That's like Rule Number One!"},
                        {
                            char = "liz2",
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "Did it have a happy child hood?"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "empty"}}
                }, {
            ...
            frames = {
                {
                    dialogs = {
                        ...
                        {char = "liz2", text = "Hey look! There's the troll."}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "troll01"}, {name = "empty"}}
                }, {
                    dialogs = {
                        {char = "liz2", text = "I didn't see him there before."},
                    ...
                    dialogs = {
                        ...
                        {char = "troll2", text = "TODAY.... TROLL BIRTHDAY..."}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "troll01"}, {name = "empty"}}
                }, {
                    dialogs = {
                        ...
                        {char = "troll2", text = "TROLL WANT FROOT LOOPS!!!"},
                        {char = "liz2", text = "Oh my gosh... so sad."},
                        {char = "troll2", text = "TROLL MOM NOT LIKE SUGAR!!!"},
    ...
    }, {
        {
            ...
            frames = {
                {
                    dialogs = {
                        {char = "kat", text = "Well then, Pascal from Tangled."},
                        {
                            char = "liz2",
                    ...
                    dialogs = {
                        ...
                        {char = "liz2", text = "Dang Kat! You’ve got skills!"},
                        {char = "liz2", text = "You can really throw down TV."}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "empty"}}
                }
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "liz2", text = "10! Yeah, you’re the best!"},
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        {char = "liz2", text = "Let's go and play with goblin"},
            ...
            frames = {
                {
                    ...
                    characters02 = {{name = "katieKooper01"}, {name = "empty"}}
                }, {
                    dialogs = {
                        {
                            char = "kat",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "You trolls like the Donut Shop?"},
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "Here's some cold stone soup."},
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "troll01", text = "Hope you have a nice trip!"}
                    },
                    characters01 = {{name = "kat"}},
                    characters02 = {
                        {name = "katieKooper01"}, {name = "troll01"},
                    ...
                    dialogs = {
                        ...
                        {char = "katieKooper01", text = "Cuuu----uuuute! OK!"},
                        {
                            char = "kat",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "liz2", text = "In that cloud.  Right there."},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    dialogs = {
                        ...
                        {char = "kat", text = "Liz, I don’t see anything."},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "Ummm... Are we playing pretend?"},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    dialogs = {
                        ...
                        {char = "liz2", text = "Oh hey Kat, what's blanging?"},
                        {char = "kat", text = "Wow Liz! Did you make that up?"},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    ...
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                        {name = "rori"}, {name = "vulcan01"}, {name = "empty"}
                    }
                }, {
                    dialogs = {
                        {
                        ...
                        {char = "rori", text = "Wait! What are those noises?"},
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "liz2", text = "Cooooool! What does that mean?"},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        ...
                        {char = "liz2", text = "You know Dennis the Menace?"},
                        {
                            char = "liz2",
                    ...
                    dialogs = {
                        {char = "kat", text = "Wait, What does grounded mean?"},
                        {
                            char = "liz2",
            ...
            frames = {
                {
                    ...
                    dialogs = {
                        {char = "kat", text = "What happened to his new shoes?"},
                        {
                            char = "dennisTheMenace",
            ...
            frames = {
                {
                    dialogs = {
                        {
                            char = "kat",
                            text = "Uugggh.  I’m bored.  I so wish we had some gold!"
                        }, {char = "liz2", text = "Yeah, me too!  And a pony!"},
                        {
                            char = "kat",
                            text = "No for real.  I need to buy this cell phone case. It's got bling ALL OVER it!"
                        }, {char = "liz2", text = "Oh my Gosh!  Cool!"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {}
                }, {
                    dialogs = {
                        {
                            char = "kat",
                            text = "This second grader named Zoe had one.  It was pink with teeny tiny jewels and sparkles ALL OVER it!"
                        },
                        {
                            char = "liz2",
                            text = "So cool!  Wait, tell me what bling is again?"
                        },
                        {char = "kat", text = "Teeny tiny jewels and sparkles."},
                        {
                            char = "liz2",
                            text = "Oh yeah! I go crazy for that stuff!"
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {}
                    ...
                    dialogs = {
                        {
                            char = "kat",
                            text = "The only problem is, it costs like 300 gold."
                        }, {char = "liz2", text = "Wow!  Is that a lot?"}, {
                            char = "kat",
                            text = "Let me put it this way= for a couple of kids like us, that’s like a million gold."
                        },
                        {
                            char = "liz2",
                            text = "Oh rats!  I’ve never even had 1 gold!"
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {}
                    ...
                    dialogs = {
                        {
                            char = "kat",
                            text = "Come on, let’s go see what’s happening at the log."
                        }, {char = "liz2", text = "I love the log!"},
                        {char = "kat", text = "We should get cell phones too."},
                        {char = "liz2", text = "We should!"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {}
                }
            ...
            frames = {
                {
                    dialogs = {
                        {
                            char = "kat",
                            text = "Hey, by the way Liz, nice shoes.   You totally slayed that outfit!"
                        },
                        {
                            char = "liz2",
                            text = "I know. Right?  Wait. What does slayed mean again?"
                        }, {
                            char = "kat",
                            text = "Oh right. Well, sometimes, people will say “the brave knight slayed the fierce dragon”."
                        }, {char = "kat", text = "You know, in the old days."},
                        {char = "liz2", text = "Back when there were castles?"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "balloons01"}}
                }, {
                    dialogs = {
                        {char = "kat", text = "Exactly, and dragons"},
                        {
                            char = "liz2",
                            text = "That is so mean!  Those poor dragons!"
                        }, {
                            char = "kat",
                            text = "It's horrible.  But actually, dragons aren’t even real."
                        }, {char = "liz2", text = "It’s still mean."}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "blank"}}
                }, {
                    dialogs = {
                        {char = "kat", text = "I guess so."}, {
                            char = "liz2",
                            text = "Kat, falling asleep to those Jack and Annie books has made you like 10 times smarter."
                        }, {char = "kat", text = "Yeah totally."}, {
                            char = "kat",
                            text = "And by the way, it’s not called Jack and Annie, it’s called Magic Treehouse."
                        },
                        {
                            char = "liz2",
                            text = "That’s what we called it at my pre-school."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "blank"}}
                    ...
                    dialogs = {
                        {
                            char = "kat",
                            text = "You’re thinking of Magic Schoolbus."
                        }, {
                            char = "liz2",
                            text = "Um, hello?.  I think I know the difference between Magic Treehouse and Magic Schoolbus!"
                        }, {char = "kat", text = "Ok fine, Fiona Frizzle."}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "blank"}}
                }, {
                    dialogs = {
                        {
                            char = "kat",
                            text = "But anyways, when a person says “you slayed that outfit”, it means you made it look super cool."
                        }, {char = "kat", text = "Like, you rocked it."},
                        {char = "liz2", text = "Oh I get it!  Say it again!"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "blank"}}
                }, {
                    dialogs = {
                        {char = "kat", text = "Girl, you slayed that outfit!"},
                        {
                            char = "liz2",
                            text = "Yeah I did!  Hee Hee Hee!  My cousin Merlinda is always saying that too."
                        }, {char = "kat", text = "You have a cousin?"},
                        {
                            char = "liz2",
                            text = "Yeah, remember, the one who is a fairy princess?"
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {{name = "blank"}, {name = "blank"}}
            ...
            frames = {
                {
                    dialogs = {
                        {
                            char = "kat",
                            text = "Your cousin is a fairy princess?"
                        }, {
                            char = "liz2",
                            text = "Um, yeah, I just said that.  Really Kat, try to keep up."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                        {name = "blank"}, {name = "dennisTheMenace"}
                    }
                }, {
                    dialogs = {
                        {
                            char = "kat",
                            text = "Your cousin is a fairy princess...  and you never told me?"
                        }, {
                            char = "kat",
                            text = "Isn’t that the kind of thing you might tell someone that you’ve known, for, I don’t know..."
                        }, {char = "kat", text = "...umpteen years?"}
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                        {name = "blank"}, {name = "dennisTheMenace"}
                    ...
                    dialogs = {
                        {
                            char = "liz2",
                            text = "Kat, I’ve told you literally 8 bazillion times. You just never listen to anything I say."
                        },
                        {
                            char = "kat",
                            text = "I remember you said your cousin was a fairy princess."
                        },
                        {
                            char = "kat",
                            text = "I just thought we were just playing pretend."
                        },
                        {
                            char = "liz2",
                            text = "I have a real life too you know."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                    ...
                    dialogs = {
                        {
                            char = "liz2",
                            text = "Hey, now that I think of it, Merlinda has tons of gold!"
                        }, {char = "kat", text = "Your cousin has gold?"},
                        {char = "liz2", text = "Yeah, tons of it.  Literally."},
                        {
                            char = "liz2",
                            text = "Boatloads of gold.  Absolute total boatloads of gold."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                    ...
                    dialogs = {
                        {
                            char = "kat",
                            text = "Do you think she will give us some, so I can buy that cell phone case?"
                        }, {
                            char = "liz2",
                            text = "Ha!  Keep dreaming Liz.  The only thing Merlinda will give us gold for is dresses."
                        }, {
                            char = "kat",
                            text = "Dresses?  You mean... like this purple thing I am wearing?"
                        },
                        {
                            char = "liz2",
                            text = "Yup.  Merlinda and her friends are nutty for dresses."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
                    ...
                    dialogs = {
                        {
                            char = "liz2",
                            text = "Oh sister.  Come on, we are going to Fairy Village."
                        }, {char = "liz2", text = "Like right now."},
                        {
                            char = "liz2",
                            text = "You are going to lose your marbles."
                        }
                    },
                    characters01 = {{name = "kat"}, {name = "liz2"}},
                    characters02 = {
    ...
    }, {
        {
            ...
            frames = {
                {
                    dialogs = {
                        ...
                        {char = "kat", text = "Sooooo.....what's the problem?"}
                    },
                    characters01 = {},
                    characters02 = {}
                }, {
            ...
            frames = {
                {
                    dialogs = {
                        {char = "liz2", text = "It glimmers and it shimmers."},
                        {
                            char = "liz2",
                    ...
                    dialogs = {
                        ...
                        {char = "kat", text = "Come on.  Let's go find Rori."},
